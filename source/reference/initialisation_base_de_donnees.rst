...
L'attribut optionnel 'extras' est un tableau associatif qui contient un ou plusieurs parametrage de base de données.La méthode get_database_extra_parameters de la classe om_application permet de recuperer ces paramètres.
